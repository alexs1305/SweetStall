...
const Map<String, Sweet> sweetsById = {
  for (final sweet in sweets) sweet.id: sweet,
};

const Location uptownMarket = Location(
  id: 'uptown',
  name: 'Uptown Market',
  sweetPriceRanges: {
...
const Location harborSide = Location(
  id: 'harbor',
...
const Location meadowRun = Location(
  id: 'meadow',
...
Sweet sweetById(String id) => sweetsById[id]!;
